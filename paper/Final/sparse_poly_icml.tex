...
\icmltitlerunning{Speeding Up Polynomial Feature Expansions of Sparse CSR Matrices Using $K$-Simplex Numbers}
...
\title{Speeding Up Polynomial Feature Expansions of Sparse CSR Matrices Using $K$-Simplex Numbers}
\maketitle
